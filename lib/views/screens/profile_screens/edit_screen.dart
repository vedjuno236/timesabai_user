...
class _EditScreenState extends State<EditScreen> {
  ...
  Future<void> _fetchEthnicity() async {
    try {
      ...
      setState(() {
        _ethnicity = ethnicity; // Update state with fetched data
      });
    } catch (error) {
    ...
    try {
      ...
      if (snap.docs.isNotEmpty) {
        ...
        setState(() {
          ...
          _txtStyController.text = Employee.qualification;
        ...
        if (agenciesId != null && agenciesId.isNotEmpty) {
          try {
            ...
            if (DepartmentDoc.exists) {
              ...
              print("No ethnicity found for this employee with ID: $agenciesId");
        ...
        if (ethnicityId != null && ethnicityId.isNotEmpty) {
          try {
            ...
            if (DepartmentDoc.exists) {
              ...
              print("No ethnicity found for this employee with ID: $ethnicityId");
              print("Ethnicity document does not exist in Firestore.");
            }
          } catch (e) {
            print("Error fetching ethnicity document: $e");
          ...
          if (departmentId != null && departmentId.isNotEmpty) {
            try {
              ...
              if (DepartmentDoc.exists) {
                ...
                print("No ethnicity found for this employee with ID: $departmentId");
                print("Ethnicity document does not exist in Firestore.");
              }
            } catch (e) {
              print("Error fetching ethnicity document: $e");
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> updateEmployee() async {
      ...
      if (_profileImage != null) {
        try {
          final storageRef = FirebaseStorage.instance.ref().child('profile_images/$employeeId.jpg');
      ...
      try {
        ...
        await FirebaseFirestore.instance.collection('Employee').doc(employeeId).update(updateData);
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text('ແກ້ໄຂຂໍ້ມູນສ່ວນຕົວ',style: GoogleFonts.notoSansLao(
              ...
              child: Column(
                  children: [
                    ...
                    Container(
                          ...
                          Stack(
                            ...
                            children: [
                              Align(
                                ...
                                child: CircleAvatar(
                                  radius: 50, // Set the radius for the desired circle size
                                  backgroundColor: Colors.transparent,
                                  child: ClipOval( // Clip the child widget to a circular shape
                     ...
                     Center(
                       child: Text("ID:${Employee.employeeId}",style: GoogleFonts.notoSansLao(
                              textStyle:  TextStyle(
                                ...
                                children: [
                                  Row(
                                    children: [
                                      ...
                                      SizedBox(width: 10),  // Space between the TextFormField and DropdownButton
                        Container(
                          height: 58,
                              ...
                              showCupertinoModalPopup(
                                ...
                                builder: (BuildContext context) {
                                  return CupertinoActionSheet(
                                    title: Text('ເລືອກເພດ', style: GoogleFonts.notoSansLao()),
                                    actions: Itemsix.map((String gender) {
                                    ...
                                    children: [
                                      Expanded(
                                        child: TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                            hintText: Employee.email.isNotEmpty ? Employee.email : "ປ້ອນ ອິເມວ",
                                            hintStyle: GoogleFonts.notoSansLao(
                                              textStyle: TextStyle(fontSize: 15, color: Colors.grey.shade600),
                                            ),
                                            enabledBorder: OutlineInputBorder(
                                              borderRadius: BorderRadius.circular(10),
                                              borderSide: const BorderSide(color: Colors.black12),
                                      ...
                                      Expanded(
                                        child: TextFormField(
                                          cursorColor: Colors.purple,
                                          controller: _txtStyController,
                                          style: GoogleFonts.notoSansLao(
                                            textStyle: TextStyle(fontSize: 16),
                                          ),
                                        decoration: InputDecoration(
                                            hintText: Employee.qualification.isNotEmpty
                                ...
                                children: [
                                  Expanded(
                                    child: TextFormField(
                                      ...
                                      style: const TextStyle(fontSize: 15, ),
                                      decoration: InputDecoration(
                                        hintText: Employee.phone.isNotEmpty ? Employee.phone : "ປ້ອນ ເບີ",
                                        hintStyle: GoogleFonts.notoSansLao(
                                          textStyle: TextStyle(fontSize: 15, color: Colors.grey.shade600),
                                        ),
                                        enabledBorder: OutlineInputBorder(
                                    ...
                                    child: GestureDetector(
                                                  ...
                                                  Expanded(
                                                    child: CupertinoDatePicker(
                                                      ...
                                                      onDateTimeChanged: (date) {
                                                        setState(() {
                                                          selectedDate = date;
                                                          _dateController.text = "${selectedDate.toLocal()}".split(' ')[0]; // Update the controller with the new date
                                                        });
                                                      },
                                                    ),
                                      ...
                                      child: AbsorbPointer(
                                        child: TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                            hintText: formattedDate.isNotEmpty ? formattedDate : "ວັນເດືອນປີເກີດ",
                                            hintStyle: GoogleFonts.notoSansLao(
          ...
          child: GestureDetector(
            onTap: () {
              showCupertinoModalPopup(
                ...
                builder: (BuildContext context) {
                  return CupertinoActionSheet(
                    title: Text('ເລືອກຕໍາແໜ່ງ', style: GoogleFonts.notoSansLao()),
                ...
                children: [
                  ...
                  Text(
                    selectedPositionId == null
                        ...
                        : _possitions
                        .firstWhere((position) => position['id'] == selectedPositionId)['name'] ?? '',
                    style: GoogleFonts.notoSansLao(
                      textStyle: const TextStyle(
                        fontSize: 16,
                        color: Colors.black54,
                                    ...
                                    child: GestureDetector(
                                      onTap: () {
                                        ...
                                        showCupertinoModalPopup(
                                          ...
                                          builder: (BuildContext context) {
                                            return CupertinoActionSheet(
                                              title: Text('ເລືອກພະແນກ', style: GoogleFonts.notoSansLao()),
                                              actions: _agencies.map((agencies) {
                                                return CupertinoActionSheetAction(
                                                  onPressed: () {
                                                    setState(() {
                                                      selectedAgenciesId = agencies['id']; // Update selected position ID
                                                    });
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              selectedAgenciesId == null
                                                  ...
                                                  : _agencies
                                                  .firstWhere((agencies) => agencies['id'] == selectedAgenciesId )['name'] ?? '',
                                              style: GoogleFonts.notoSansLao(
                                                textStyle: const TextStyle(
                                                  fontSize: 16,
                                                  color: Colors.black54,
                                                  ...
                                                  builder: (BuildContext context) {
                                                    return Container(
                                                      ...
                                                      child: CupertinoActionSheet(
                                                        title: Text(Employee.ethnicityModel?.name ??'ເລືອກຊົນເຜົ່າ',
                                                            style: GoogleFonts.notoSansLao()),
                                                        actions: _ethnicity.map((ethnicity) {
                                                          return CupertinoActionSheetAction(
                                                            onPressed: () {
                                                              setState(() {
                                                                selectedEthnicityId = ethnicity['id']; // Update selected ethnicity
                                                              });
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      selectedEthnicityId == null
                                                          ? 'ເລືອກຊົນເຜົ່າ'
                                                          : _ethnicity
                                                          .firstWhere((ethnicity) => ethnicity['id'] == selectedEthnicityId)['name'],
                                                      style: GoogleFonts.notoSansLao(
                                                        textStyle: const TextStyle(
                                                          fontSize: 16,
                                                          color: Colors.black54,
                                            ...
                                            return Container(
                                              ...
                                              child: CupertinoActionSheet(
                                                ...
                                                actions: _provinces.map((province) {
                                                  return CupertinoActionSheetAction(
                                                    onPressed: () {
                                                      _onProvinceSelected(province['id']!);
                                                    },
                                                    child: Text(
                                                      province['name'] ?? '',
                                                      style: GoogleFonts.notoSansLao(
                                          ...
                                          builder: (BuildContext context) {
                                            return Container(
                                              ...
                                              child: CupertinoActionSheet(
                                                ...
                                                actions: _selectedProvince != null && _cities.isNotEmpty
                                                    ? _cities.map((city) {
                                                  return CupertinoActionSheetAction(
                                                    onPressed: () {
                                                      setState(() {
                              ...
                              Row(
                                ...
                                children: [
                                        ...
                                        showCupertinoModalPopup(
                                          ...
                                          builder: (BuildContext context) {
                                            return CupertinoActionSheet(
                                              ...
                                              actions: _departments.map((department) {
                                                return CupertinoActionSheetAction(
                                                  onPressed: () {
                                                    _onDepartmentSelected(department['id']);
                                            ...
                                            Text(
                                              _selectedDepartment == null
                                                  ...
                                                  : _departments.firstWhere(
                                                    (department) => department['id'] == _selectedDepartment,
                                                orElse: () => {'name': ''},
                                              )['name']!,
                                              style: GoogleFonts.notoSansLao(
                                                textStyle: const TextStyle(
                                  ...
                                  Expanded(
                                    child: GestureDetector(
                                      onTap: () {
                                        if (_selectedDepartment != null && _branches.isNotEmpty) {
                                            ...
                                            Text(
                                              _selectedBranch == null
                                                  ...
                                                  : _branches.firstWhere(
                                                    (branch) => branch['id'] == _selectedBranch,
                                                orElse: () => {'name': ''},
                                              )['name']!,
                                              style: GoogleFonts.notoSansLao(
                                                textStyle: const TextStyle(
