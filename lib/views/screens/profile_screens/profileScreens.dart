    ...
    try {
      ...
      if (snap.docs.isNotEmpty) {
        ...
        setState(() {
          ...
          DocumentReference positionRef = FirebaseFirestore.instance
              .collection("Position")
              .doc(positionId);
  ...
  Widget build(BuildContext context) {
    return Consumer(
      builder: (context, ref, _) {
        final isDarkMode = ref.watch(isDarkProvider); // Accessing the dark mode state
        ...
        title: Text('ຂໍ້ມູນລະບົບ',style: GoogleFonts.notoSansLao(
                    ...
                    children: [
                      ...
                      CircleAvatar(
                        ...
                        backgroundImage: Employee.profileimage.isNotEmpty
                            ...
                            : const NetworkImage('https://i.pinimg.com/736x/59/37/5f/59375f2046d3b594d59039e8ffbf485a.jpg'),
                        onBackgroundImageError: (exception, stackTrace) => const Icon(Icons.error),
                        child: Employee.profileimage.isEmpty
                            ? const Icon(Icons.person) // Placeholder icon if no image is provided
                            : null,
                      ),
                          ...
                          title:   Text(
                            ...
                            actions: [
                              CupertinoActionSheetAction(
                                ...
                                child:  Text("ລາວ",style: GoogleFonts.notoSansLao(
                                textStyle: const TextStyle(
                                fontSize: 16,
                                ),
                              ),
                            ...
                            cancelButton: CupertinoActionSheetAction(
                              onPressed: () {
                                Navigator.pop(context); // Close the modal without changing anything
                              },
