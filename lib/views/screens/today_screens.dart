                                      ...
                                      return SlideAction(
                                          ...
                                          onSubmit: () async {
                                            ...
                                            if (snap.docs.isNotEmpty) {
                                              ...
                                              // Retrieve check-in settings time
                                              DateTime settingDate =
                                                  DateTime.now();
                                              QuerySnapshot
                                                  timeSettingsSnapshot =
                                                  await FirebaseFirestore
                                                      .instance
                                                      .collection("times")
                                                      .get();
                                              ...
                                              for (DocumentSnapshot doc
                                                  in timeSettingsSnapshot
                                                      .docs) {
                                                if (doc.exists) {
                                                  Timestamp settingTimestamp =
                                                      doc['times'];
                                                  settingDate =
                                                      settingTimestamp.toDate();
                                                }
                                              }
